			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: s.hint,
						children: [
							"API 扩展链接获取：Cubox 偏好设置 → 扩展中心和自动化 → API 扩展 → 启用并复制链接。链接是个人身份凭证，请勿泄露。 token 与同步快照分别存于 ~/.dsh/dsh-cubox.json 与 ~/.dsh/dsh-cubox-cache.json（权限 0600）。 配置导出目录后，每次同步会按上方设置写入：勾选卡片时每张收藏一个 md；配置了 AI Key 时按提示词生成「今日收藏简报-日期.md」到该目录（",
							"{collection}",
							" 替换为今日收藏列表，未包含则自动追加）。"
						]
					})
