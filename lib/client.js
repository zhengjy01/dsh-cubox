			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: s.hint,
						children: [
							"API 扩展链接获取：Cubox 偏好设置 → 扩展中心和自动化 → API 扩展 → 启用并复制链接。链接是个人身份凭证，请勿泄露。 token 与同步快照分别存于 ~/.dsh/dsh-cubox.json 与 ~/.dsh/dsh-cubox-cache.json（权限 0600）；flomo 凭据与「Flomo」面板共享（~/.dsh/dsh-flomo.json，0600）。 「轮询同步间隔(分钟)」控制定时同步（含 flomo 标注推送）的频率，建议 60–120，0 关闭定时；「flomo 标签」在下方「flomo 标注同步」区设置——两者点「保存配置」后即时生效，无需重启。 配置导出目录后，每次同步会按上方设置写入：勾选卡片时每张收藏一个 md；配置了 AI Key 时按提示词生成「今日收藏简报-日期.md」（",
							"{collection}",
